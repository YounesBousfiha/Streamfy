...
import { Check, Play, Plus, ThumbsUp, X, Loader } from 'lucide-react';
...
export const DetailModal = () => {
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto bg-black/80 backdrop-blur-md pt-8 pb-8 px-4 animate-in fade-in duration-200">
            ...
            <div className="relative w-full max-w-4xl bg-[#181818] rounded-xl shadow-2xl overflow-hidden ring-1 ring-white/10 min-h-[500px]">
                ...
                {loading ? (
                    <div className="h-[500px] flex flex-col items-center justify-center gap-4 text-white">
                        <Loader className="w-12 h-12 animate-spin text-[#e50914]" />
                        <p className="text-lg font-medium animate-pulse">Chargement en cours...</p>
                    </div>
                ) : (
                    <>
                        {/* ZONE 1: PLAYER */}
